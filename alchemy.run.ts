...
export default Alchemy.Stack(
  ...
  Effect.gen(function* () {
    ...
    // Self-host custom domain. Upstream sets a Worker domain only for
    // hosted-prod, leaving every other stage on *.workers.dev. Unset keeps
    // upstream behaviour exactly; set, it serves the stage from one hostname.
